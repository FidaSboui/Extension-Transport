tableextension 84021 tableextension84021 extends "Payment Line"
{
    fields
    {
        field(81000; "WithHold Tax Amount"; Decimal)
        {
            ...
            CalcFormula = Sum ("WithHolding Tax Entries"."WithHold Amount" WHERE("Payment Slip No." = FIELD("No."), "Payment Slip Line No." = FIELD("Line No."), Posted = FILTER(true)));
        }
        ...
        field(86000; "Payment Title No."; Text[30])
        {
            ...
            DataClassification = ToBeClassified;
            Description = 'WI004';
            TableRelation = "Bank Checks"."Check No." WHERE("Bank Account No." = FIELD("Header Account No."),
